...
//Rare exceptions to indicate a bug in the _titaniumkoo code (Eg, function that a subclass should have implemented)
...
/**
 The base class for _titaniumkookoo proxies.
 */

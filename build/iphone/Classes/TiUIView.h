...
/**
 Base class for all _titaniumkookoo views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the _titaniumkookoo view hierarchy (such as wrapped iOS UIViews) was touched.

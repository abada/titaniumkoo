 ...
 * Copyright (c) 2009-2014 by _titaniumkookoo, Inc. All Rights Reserved.
...
-(id)call:(NSArray*)args
{
	...
	{
		@throw [NSException exceptionWithName:@"org.titaniumkoo.kroll" reason:[NSString stringWithFormat:@"invalid method '%@'",NSStringFromSelector(selector)] userInfo:nil];
	}
	id arg1=nil;
	id arg2=nil;

...
@interface _titaniumkookooObject : KrollCoverageObject {
#else
@interface _titaniumkookooObject : KrollObject {
#endif
@private
...
extern NSString * _titaniumkookoo$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	_titaniumkookooObject *_titaniumkoo;
    KrollObject* console;
	BOOL shutdown;
